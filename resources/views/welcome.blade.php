...
@php
    ...
    foreach ($countries as $index => $country) {
        $countries[$index]['languages'][0] = [
                'code' => $country['country_data']['language_code'],
                'name' => $country['name'],
                'native' => null,
                'is_official' => true
 ];
        unset($countries[$index]['country_data']['language_code']);
        unset($countries[$index]['country_data']['language_name']);
    }
